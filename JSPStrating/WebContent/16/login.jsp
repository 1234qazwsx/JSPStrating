...
<script type="text/javascript">
	function check(form){
		...
		if(document.forms.loginForm.passwd.value== ""){
			alert("请输入密码！")
				document.forms.loginForm.passwd.focus();
			return false;
		}
	}
</script>
...
<body>
	<form action="<%= request.getContextPath() %>/loginServlet16" method="get" name="loginForm">
